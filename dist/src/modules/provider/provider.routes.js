...
router.post("/gear/category", auth(Role.PROVIDER, Role.ADMIN), providerController.createCategory);
router.get("/gear/category", auth(Role.PROVIDER, Role.ADMIN), providerController.getCategories);
